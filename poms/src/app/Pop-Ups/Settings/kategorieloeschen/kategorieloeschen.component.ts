...
export class KategorieloeschenComponent implements OnInit {
  ...
  onSaveButton():void{
    ...
    //console.log(this.deleteKategorie.value.deleteCategory)
   this.backendService.removeCategoryByName(categoryDelete).then(response => console.log("removeCategoryByName", response))
  }
